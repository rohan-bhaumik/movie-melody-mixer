...
export default function HomePage() {
  ...
  // Mock data generator based on movie titles (fallback)
  const generateMockVideos = (movieTitle: string): YouTubeVideo[] => {
    const movieVideos: { [key: string]: YouTubeVideo[] } = {
      'pulp fiction': [
        { 
          id: 'dQw4w9WgXcQ',
  ...
  const handleMovieSubmit = async (movie: string) => {
    ...
    setTimeout(() => {
      const generatedVideos = generateMockVideos(movie);
